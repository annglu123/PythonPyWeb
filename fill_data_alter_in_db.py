...
if __name__ == "__main__":
    ...
    t2 = time()
    print(
        f"Записи таблицы 'AuthorProfile' успешно созданы. Время создания {len(data_author_profile)} строк {t2 - t1:.4f} с")
    ...
    for entry in data_entry:
        ...
        pub_date = timezone.make_aware(
            pub_date)  # добавляем данных о часовом поясе, так как могут быть проблемы с БД и Django
        obj = Entry(blog=blog,
